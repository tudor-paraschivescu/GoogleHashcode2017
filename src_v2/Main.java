...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            String inputFile = "trending_today.in";
            ...
            Collections.sort(requests, new Comparator<Request>() {
                ...
                public int compare(Request o1, Request o2) {
                    ...
                    Endpoint e1 = ends.get(o1.endpoint);
                    Endpoint e2 = ends.get(o2.endpoint);
                    
                    int r1 = o1.numberOfRequests;
                    int r2 = o2.numberOfRequests;
                    
                    int requestRank1 = r1;
                    int requestRank2 = r2;
                    
                    if (!e1.latencyK.isEmpty() && !e2.latencyK.isEmpty()) {
                        requestRank1 = r1 * (e1.latencyD - e1.latencyK.get(0).latency);
                        requestRank2 = r2 * (e2.latencyD - e2.latencyK.get(0).latency);   
                    }
                    
                    return requestRank2 - requestRank1;
                }
            });
